...
for i = 1:length(files)
    ...
    % Replace EMG processing with wider bandstop filter
    ...
    [R_HC_feats,featlabels] = extractfeats_mat(IMU_DAQ_CHAN_LP,GONIO_DAQ_CHAN_LP_FINAL,EMG_ALLFILT,RorL,R_IC,WinLen,WinInc,MaxDelay);
    [R_TO_feats,~] = extractfeats_mat(IMU_DAQ_CHAN_LP,GONIO_DAQ_CHAN_LP_FINAL,EMG_ALLFILT,RorL,R_EC,WinLen,WinInc,MaxDelay);
    RorL = 2; % Left foot is ipsilateral
    [L_HC_feats,~] = extractfeats_mat(IMU_DAQ_CHAN_LP,GONIO_DAQ_CHAN_LP_FINAL,EMG_ALLFILT,RorL,L_IC,WinLen,WinInc,MaxDelay);
    [L_TO_feats,~] = extractfeats_mat(IMU_DAQ_CHAN_LP,GONIO_DAQ_CHAN_LP_FINAL,EMG_ALLFILT,RorL,L_EC,WinLen,WinInc,MaxDelay);
...
save(['AllSubs_feats_reprocessed.mat'],'feats','legphase','trig','subject','featlabels');
end